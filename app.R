      ...
      tabItem(tabName = 'page9', h2('Regression Model of Population'),
              ...
              pageWithSidebar(
                ...
                mainPanel(
                  ...
                  plotOutput('RgsM'),
                  h3('If you wish to reset the slidebar, press Reset button, then press Submit button.')
                )
      ...
      tabItem(tabName = 'page10',
              ...
              pageWithSidebar(
                ...
                sidebarPanel(
                  h2('Contributor:'), 
                  h3('Liew Chuan Nyen'),
                  h4('Contribution: Population Trend, Population Structure, Economic Trend, Correlation Analysis, Regression Model of Population'),
                  h3('Low wai Yen'),
                  h4('Contribution: Overvierw, Population by age group & ethnic, Population table'),
                  h3('Izzura Malindo '),
                  h4('Contribution: Github Code Compilation, Documentation, Slidify, Presentation')
                ...
                mainPanel(
                  h2('User Guidelines: '),
                  h3('Overview'),
                  h4('This page shows the overall breakdown of Malaysian population as well as the Malaysian citizen population growth from 2010 to 2019.'),
                  h3('Population by age group & ethnic'),
                  h4('This page shows the overall summary of population in bar chart based on different age group and ethnic'),
                  h3('Population Table'),
                  h4('This page shows the population table of Malaysia'),
                  h3('Statistical Summary'),
                  h4('This page shows the statistical summary of selected group of Malaysia Population, including the observation, maximum and minimum number, median, mean, first and thrid quartile of the observation.'),
                  h3('Population Trend'),
                  h4('This page shows the population trend of specific group of Malaysia population by plotting the bar chart.'),
                  h3('Population Structure'),
                  h4('This page shows the comparison between the population between specific group of Malaysia population by using bar chart. The Filling input represent the component variables included in each single bar in the graph while the Faceting represent the way the plot is split into a matrix of panels based of variable selected.'),
                  h3('Economic Trend'),
                  h4('This page shows the overall trend of Malaysia economic trend by using bar chart.'),
                  h3('Correlation Analysis'),
                  h4('This page shows the correlation summary of the selected variables'),
                  h3('Regression Model of Population'),
                  h4('This page shows the regression model of Malaysia population, it use Malaysia economic trend to infer the population of Malaysia. The default coefficienct was based on the correlation analysis between Malaysia population and Malaysia economic trend. User can use the slidebar to modify the coefficient and click submit to observe the changes. If you wish to reset the slide bar to default value, simply press Reset button then presss Submit button.'),
                )
